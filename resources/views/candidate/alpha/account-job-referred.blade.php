...
<section id="intro" class="clearfix front-intro-section">
    <div class="container">
        ...
        <div class="intro-info">
            <h2><span>{{ __('message.account') }} > {{ __('message.job_referred') }}</span></h2>
        </div>
    </div>
</section>
<!-- #intro -->
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="job-listing">
                                ...
                                <p class="job-listing-job-info">
                                    <span class="job-listing-job-info-date"><i class="fa fa-clock-o"></i> {{ __('message.referred_on') }} : {{ timeFormat($job['referred_on']) }}</span>
                                ...
                                <div class="job-listing-job-description">
                                    <strong>
                                    {{ __('message.name') }} : {{ trimString($job['name']) }}<br />
                                    {{ __('message.email') }} : {{ trimString($job['email']) }}<br />
                                    {{ __('message.phone') }} : {{ trimString($job['phone']) }}
                                    </strong>
                                </div>
                                <div class="container">
