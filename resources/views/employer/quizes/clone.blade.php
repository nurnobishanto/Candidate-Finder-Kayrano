<form id="employer_quiz_clone_form">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value="{{ $quiz['title'] }} - {{__('message.cloned')}}">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-blue" id="employer_quiz_clone_form_button">{{ __('message.save') }}</button>
    </div>
</form>