<form id="employer_question_create_update_form">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <option value="{{ encode($category['question_category_id']) }}" {{ sel($question['question_category_id'], $category['question_category_id']) }}>
                    {{ $category['title'] }}
                    </option>
                    @endforeach
                    @endif
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control dropify" name="image" data-id="{{ $question_id }}"
            ...
            <div class="col-md-12">
                ...
                <div class="row answers-container">
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="hidden" name="answer_ids[]" class="form-control" 
                                value="{{ encode($answer['question_answer_id']) }}" />
                    ...
                    <div class="col-md-2 text-center">
                        <div class="form-group">
                            <i class="fa fa-trash text-red remove-answer" data-id="{{ encode($answer['question_answer_id']) }}" 
                ...
                @include('employer.questions.new-answer-item')
                @include('employer.questions.new-answer-item')
                @endif
            </div>
            <div class="col-md-12">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-blue" id="employer_question_create_update_form_button">{{ __('message.save') }}</button>
    </div>
</form>