<form id="admin_faqs_categories_create_update_form">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-blue" id="admin_faqs_categories_create_update_form_button">{{__('message.save') }}</button>
    </div>
</form>