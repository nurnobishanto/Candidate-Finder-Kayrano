            ...
            <div class="row align-items-center h-100">
                ...
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
                        <img src="{{route('uploads-view', 'general/features/quizes.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="section-features-element-2">
            <div class="row align-items-center h-100">
                <div class="col-md-6">
                    <div class="section-features-element-left slide-from-left">
                        <img src="{{route('uploads-view', 'general/features/interviews.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
    ...
    <div class="container">
        <div class="section-features-element-3">
            <div class="row align-items-center h-100">
                ...
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
                        <img src="{{route('uploads-view', 'general/features/self-assesment.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="section-features-element-4">
            <div class="row align-items-center h-100">
                <div class="col-md-6">
                    <div class="section-features-element-left slide-from-left">
                        <img src="{{route('uploads-view', 'general/features/job-board.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
    ...
    <div class="container">
        <div class="section-features-element-5">
            <div class="row align-items-center h-100">
                ...
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
                        <img src="{{route('uploads-view', 'general/features/resume.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="section-features-element-6">
            <div class="row align-items-center h-100">
                <div class="col-md-6">
                    <div class="section-features-element-left slide-from-left">
                        <img src="{{route('uploads-view', 'general/features/filters.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
    ...
    <div class="container">
        <div class="section-features-element-7">
            <div class="row align-items-center h-100">
                ...
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
                        <img src="{{route('uploads-view', 'general/features/refer-job.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="section-features-element-8">
            <div class="row align-items-center h-100">
                <div class="col-md-6">
                    <div class="section-features-element-left slide-from-left">
                        <img src="{{route('uploads-view', 'general/features/personalized.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
    ...
    <div class="container">
        <div class="section-features-element-9">
            <div class="row align-items-center h-100">
                ...
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
                        <img src="{{route('uploads-view', 'general/features/role-permissions.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="section-features-element-10">
            <div class="row align-items-center h-100">
                <div class="col-md-6">
                    <div class="section-features-element-left slide-from-left">
                        <img src="{{route('uploads-view', 'general/features/reports.png')}}"  onerror="this.src='{{$error}}'" class="container_img"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-features-element-right slide-from-right">
