    ...
    <div class="breadcrumbs">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-9">
                    <h2>{{__('message.job_favorites')}}</h2>
                </div>
                <div class="col-md-3">
                    <div class="breadcrumbs-text-right">
                        <p class="text-lg-end">
                            ...
                            <a href="{{route('front-acc-job-favs')}}">{{__('message.job_favorites')}}</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="account-detail-container">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    @php $onerror = url('/g-assets').'/essentials/images/company-not-found.png'; @endphp
                    @if ($jobs)
                    @foreach ($jobs as $job)
                    <div class="row">
                        <div class="col-md-12">
