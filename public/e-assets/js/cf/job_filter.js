function JobFilter() {
    ...
    this.initJobFiltersDatatable = function () {
        $('#job_filters_datatable').DataTable({
            ...
            "ajax": {
                "type": "POST",
                "url": application.url+'/employer/job-filters/data',
                "data": function ( d ) {
                    d.status = $('#status').val();
    ...
    this.initJobFilterUpdateValuesForm = function () {
        ...
        $('.add-job-filter-values').on('click', function () {
            ...
            application.load('/employer/job-filters/update-values/'+id, modal+' .modal-body-container', function (result) {
    ...
    this.initJobFilterAddValue = function () {
        ...
        $('.add-value').on('click', function () {
            application.load('/employer/job-filters/new-value', '', function (result) {
    ...
    this.initJobFilterValuesSave = function () {
        application.onSubmit('#employer_job_filter_values_update_form', function (result) {
            ...
            application.post('/employer/job-filters/update-values', '#employer_job_filter_values_update_form', function (res) {
                ...
                if (result.success === 'true') {
                    ...
                    application.showMessages(result.messages, 'employer_job_filter_values_update_form');
                }
            });
        });
    };
    ...
    this.initJobFilterCreateOrEditForm = function () {
        ...
        $('.create-or-edit-job-filter').on('click', function () {
            ...
            application.load('/employer/job-filters/create-or-edit'+id, modal+' .modal-body-container', function (result) {
    ...
    this.initJobFilterSave = function () {
        application.onSubmit('#employer_job_filter_create_update_form', function (result) {
            ...
            application.post('/employer/job-filters/save', '#employer_job_filter_create_update_form', function (res) {
                var result = JSON.parse(application.response);
                if (result.success === 'true') {
                    $('#modal-default').modal('hide');
                    self.initJobFiltersDatatable();
                    ...
                    application.showMessages(result.messages, 'employer_job_filter_create_update_form');
                }
            });
        });
    };
    ...
    this.initJobFilterChangeStatus = function () {
        ...
        $('.change-job-filter-status').on('click', function () {
            ...
            application.load('/employer/job-filters/status/'+id+'/'+status, '', function (result) {
    ...
    this.initJobFilterDelete = function () {
        ...
        $('.delete-job-filter').on('click', function () {
            ...
            var id = $(this).data('id');
            if (status === true) {
                application.load('/employer/job-filters/delete/'+id, '', function (result) {
                    self.initJobFiltersDatatable();
                });
            }
        });
